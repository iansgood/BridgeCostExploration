function [h_Str,h_Def] = thickness(tr,yeild,E)
%{
...
h_Str = sqrt(8.* p.*tr.length_eng ./ tr.width.*yeild/1E6); %in m
h_Def = (p.*tr.length_eng.^3./(4*tr.width.*E/1E6.*tr.deflectionMax)).^1/3; %in m
end
